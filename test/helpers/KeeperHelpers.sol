...
abstract contract KeeperHelpers is Test {
    ...
    function _setVaultReward(SetVaultRewardParams memory params)
        internal
        returns (IKeeperRewards.HarvestParams memory harvestParams)
    {
        ...
        bytes32 rewardsRoot =
            keccak256(bytes.concat(keccak256(abi.encode(params.vault, params.totalReward, params.unlockedMevReward))));
        ...
        return IKeeperRewards.HarvestParams({
            rewardsRoot: rewardsRoot,
