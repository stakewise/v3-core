...
import { EthOracle, EthVault, EthVaultMock, Signers } from '../typechain-types'
...
describe('EthVault - deposit', () => {
  ...
  let vault: EthVault, oracle: EthOracle, signers: Signers, validatorsRegistry: Contract
  ...
  beforeEach('deploy fixtures', async () => {
    ;({ createVault, createVaultMock, oracle, signers, validatorsRegistry, getSignatures } =
  ...
  describe('full vault: assets & shares', () => {
    ...
    it('fails when not harvested', async () => {
      ...
      await updateRewardsRoot(oracle, signers, getSignatures, [
