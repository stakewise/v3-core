...
contract VaultTokenTest is Test, EthHelpers {
    ...
    function test_transfer() public {
        ...
        assertEq(ownerFinalBalance, ownerInitialBalance - transferAmount, "Owner balance should decrease");
        assertEq(user1FinalBalance, user1InitialBalance + transferAmount, "User1 balance should increase");
    }
    ...
    function test_transferFrom() public {
        ...
        assertEq(ownerFinalBalance, ownerInitialBalance - approvalAmount, "Owner balance should decrease");
        assertEq(user1FinalBalance, user1InitialBalance + approvalAmount, "User1 balance should increase");
    ...
    function test_permit() public {
        ...
        bytes32 structHash = keccak256(abi.encode(permitTypehash, signer, user1, permitAmount, nonce, deadline));
