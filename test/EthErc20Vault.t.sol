...
contract EthErc20VaultTest is Test, EthHelpers {
    ...
    function test_depositAndMintOsToken() public {
        ...
        uint256 mintedAssets = vault.depositAndMintOsToken{value: depositAmount}(sender, osTokenShares, referrer);
        _stopSnapshotGas();
    ...
    function test_updateExitQueue_emitsTransfer() public {
        ...
        IKeeperRewards.HarvestParams memory harvestParams = _setEthVaultReward(address(vault), int160(1 ether), 0);
