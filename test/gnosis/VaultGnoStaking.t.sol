...
contract VaultGnoStakingTest is Test, GnoHelpers {
    ...
    function test_deposit() public {
        ...
        assertEq(
            contracts.gnoToken.balanceOf(sender), senderInitialBalance - depositAmount, "Sender balance should decrease"
        );
        assertEq(
    ...
    function test_vaultAssets() public {
        ...
        uint256 senderDeposit = vault.convertToAssets(queuedShares) + totalExitingAssets + unclaimedAssets + 1 ether;
        ...
        assertEq(vault.totalAssets(), initialAssets + senderDeposit, "Total assets should increase by deposit amount");
    ...
    function test_registerValidators_succeeds() public {
        ...
        IKeeperValidators.ApprovalParams memory approvalParams =
            _getGnoValidatorApproval(address(vault), 1 ether, "ipfsHash", true);
    ...
    function test_validatorRegistration_minMaxEffectiveBalance() public {
        ...
        IKeeperValidators.ApprovalParams memory approvalParams =
            _getGnoValidatorApproval(address(vault), tooSmallAmount, "ipfsHash", false);
    ...
    function test_transferVaultAssets() public {
        ...
        uint256 senderDeposit =
            vault.convertToAssets(queuedShares) + totalExitingAssets + unclaimedAssets + depositAmount;
        _mintGnoToken(sender, senderDeposit);
