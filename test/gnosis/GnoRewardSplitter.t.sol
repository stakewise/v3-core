...
contract GnoRewardSplitterTest is Test, GnoHelpers {
    ...
    function test_maxWithdrawal() public {
        ...
        IKeeperRewards.HarvestParams memory harvestParams = _setGnoVaultReward(vault, int160(int256(1 ether)), 0);
    ...
    function test_notHarvestedInSyncRewards() public {
        ...
        vm.mockCall(vault, abi.encodeWithSelector(IVaultState.isStateUpdateRequired.selector), abi.encode(true));
    ...
    function test_manageShares() public {
        ...
        assertEq(
            newSharesShareholder1, initialSharesShareholder1 + increaseAmount, "Shares should be increased correctly"
        );
        ...
        assertEq(
            finalSharesShareholder1, initialSharesShareholder1, "Shares should be decreased back to original amount"
        );
