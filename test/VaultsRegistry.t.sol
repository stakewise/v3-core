...
contract VaultsRegistryTest is Test, EthHelpers {
    ...
    function test_initialState() public view {
        ...
        assertFalse(registry.vaultImpls(mockVaultImpl), "Mock vault impl should not be registered initially");
    ...
    function test_addVaultImpl_notOwner() public {
        ...
        assertFalse(registry.vaultImpls(mockVaultImpl), "Vault implementation should not be registered");
    }
    ...
    function test_removeVaultImpl_notOwner() public {
        ...
        assertTrue(registry.vaultImpls(mockVaultImpl), "Vault implementation should still be registered");
    }
