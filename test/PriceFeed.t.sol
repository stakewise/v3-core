...
contract PriceFeedTest is Test, EthHelpers {
  ...
  function test_constructor() public view {
    ...
    assertEq(
      ...
      'StakeWise osETH/ETH Price Feed',
  ...
  function test_interfaceConsistency() public view {
    ...
    assertEq(
      int256(balancerRate),
      chainlinkAnswer,
      'Balancer rate and Chainlink answer should be consistent'
    );
    ...
    assertEq(
      chainlinkAnswer,
      roundDataAnswer,
      'Chainlink answer and round data answer should be consistent'
    );
  }
  ...
  function test_timestampConsistency() public view {
    ...
    assertEq(
      timestamp,
      block.timestamp,
      'Timestamp from latestTimestamp should be block.timestamp'
    );
