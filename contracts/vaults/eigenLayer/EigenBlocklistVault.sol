...
import {IEigenBlocklistVault} from '../../interfaces/IEigenBlocklistVault.sol';
...
/**
 * @title EigenBlocklistVault
 * @author StakeWise
 * @notice Defines the EigenLayer staking Vault with blocking addresses functionality
 */
contract EigenBlocklistVault is Initializable, EigenVault, VaultBlocklist, IEigenBlocklistVault {
  ...
  function vaultId() public pure virtual override(IVaultVersion, EigenVault) returns (bytes32) {
    return keccak256('EigenBlocklistVault');
  }
