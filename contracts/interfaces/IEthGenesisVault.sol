...
interface IEthGenesisVault is IEthVault {
  ...
  /**
   * @notice Event emitted on EthGenesisVault creation (deprecated)
  ...
  /**
   * @notice Function for migrating from StakeWise Legacy. Can be called only by RewardEthToken contract.
